...
final class OnPublicationRequestedEvent extends Event
{
    ...
    private ?string $createdArticleId = null;
    ...
    public function setCreatedArticleId(string $articleId): void
    {
        $this->createdArticleId = $articleId;
    }

    public function getCreatedArticleId(): ?string
    {
        return $this->createdArticleId;
    }
}
